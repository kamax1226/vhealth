...
const FreeRelatedProducts = () => (
  <div className="pt-15 mb-0">
    ...
    <div className="mb-0">
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-html-free"
      ...
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-vue-free"
        className="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4"
      >
        {/* begin::Info */}
        <div className="d-flex align-items-center me-1">
      ...
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-react-free"
      ...
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-html-pro"
        className="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4"
      >
        {/* begin::Info */}
        <div className="d-flex align-items-center me-1">
      ...
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-vue-pro"
        className="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4"
      >
        {/* begin::Info */}
        <div className="d-flex align-items-center me-1">
      ...
      {/* begin::Product */}
      <a
        href="https://ohba.com/products/start-react-pro"
        className="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4"
      >
        {/* begin::Info */}
        <div className="d-flex align-items-center me-1">
